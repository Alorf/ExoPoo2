...
import bibliotheque.mvp.model.auteur.AuteurModel;
import bibliotheque.mvp.model.lecteur.LecteurModel;
import bibliotheque.mvp.model.ouvrage.OuvrageModel;
import bibliotheque.mvp.model.rayon.RayonModel;
import bibliotheque.mvp.presenter.*;
import bibliotheque.mvp.view.ViewInterface;
import bibliotheque.mvp.view.auteur.AuteurViewConsole;
...
import bibliotheque.mvp.view.ouvrage.OuvrageViewConsole;
import bibliotheque.mvp.view.ouvrage.OuvrageViewInterface;
import bibliotheque.mvp.view.rayon.RayonViewConsole;
...
public class GestBiblio {
    ...
    private ExemplaireViewInterface ev;
    private ExemplairePresenter ep;


    private DAO<Location> locm;
    private LocationViewInterface locv;
    private LocationPresenter locp;
*/
    public void gestion(){
        lm = new LecteurModel();
